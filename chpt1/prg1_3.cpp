...
int main(int argc, char* argv[])
{
  ...
  //Init:
  Ec = 1.0;                      //The transmitted energy per MDPSK symbol is 1.
  Eb = Ec / 2.0;                 //The transmitted energy per bit is 0.5Ec for DQPSK.
  ...
  for (i=0; i<EbN0dB.length(); i++) {
    ...
    //Modulate the bits to MDPSK symbols:
    ...
    //Demodulate the received MDPSK symbols into received bits: 
